...
hl("String", { fg = colors.bright_cyan })
hl("Character", { fg = colors.bright_cyan })
...
hl("DiagnosticHint", { fg = colors.bright_cyan })
...
hl("DiagnosticVirtualTextHint", { fg = colors.bright_cyan, bg = colors.bg_alt })
...
hl("SpellRare", { undercurl = true, sp = colors.magenta })
